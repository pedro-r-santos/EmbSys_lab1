...
COMPILER_FLAGS:=-g -pedantic -Wall -Wextra -Walloca -Wanon-enum-enum-conversion -Warc-maybe-repeated-use-of-weak \
    ...
    -Wcompound-token-split-by-space -Wconditional-uninitialized -Wconsumed -Wconversion -Wconversion-null \
    -Wcovered-switch-default -Wcstring-format-directive -Wcustom-atomic-properties -Wdate-time -Wdeprecated \
    -Wdocumentation -Wdocumentation-deprecated-sync -Wdocumentation-pedantic -Wdocumentation-unknown-command \
